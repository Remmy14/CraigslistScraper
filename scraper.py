    ...
    for thing in thing_list:
        ...
        for item in new_items:
            ...
            if pid not in postings:
                ...
                try:
                    msg = gmail.Message('New Humidor Found on Craigslist', to = 'alex.remillard@gmail.com', text=body)
                    gm.send(msg)
                    postings.append(pid)
                except:
            ...
            logging.info("For item {0} we found {1} items, {2} of which are new".format(thing, number_of_items, number_of_new_items))

            # Sleep for between 3 and 5 minutes
